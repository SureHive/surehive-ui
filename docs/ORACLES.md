...
Each price feed has a pair token0/token1, SURE/ETH or SURE/USD for example, decimals, and proxy. We use this information to construct mappings of the price feed to their respectful pair tokens.
