...
export default function Repay({ pair }: RepayProps) {
  ...
  const warnings = new Warnings()
    .addError(
      ...
      `You cannot MAX repay ${pair.asset.tokenInfo.symbol} directly from your wallet. Please deposit your ${pair.asset.tokenInfo.symbol} into the SureVault first, then repay. Because your debt is slowly accrueing interest we can't predict how much it will be once your transaction gets mined.`
    )
    .addError(
    ...
    .addError(
      ...
      new Warning(
        ...
        `Please make sure your ${
          useBentoRepay ? 'SureVault' : 'wallet'
