          ...
          <div className="flex w-full sm:w-2/5 items-center">
            <div className="flex gap-4 items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === SURE[ChainId.MAINNET] || currency === XSUSHI) && (
                  <Typography
                    variant="xs"
                    className="underline text-blue cursor-pointer"
                    onClick={() => setCurrency(currency === XSUSHI ? SURE[ChainId.MAINNET] : XSUSHI, field)}
                  >
                    {currencies[field] === SURE[ChainId.MAINNET] ? i18n._(t`Use nSURE`) : i18n._(t`Use SURE`)}
                  </Typography>
                )}
              </div>
            </div>
