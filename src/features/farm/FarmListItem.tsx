        ...
        <>
          <Disclosure.Button
            className={classNames(
              open && 'rounded-b-none',
              'w-full px-4 py-6 text-left rounded cursor-pointer select-none bg-gray-200 text-primary text-sm md:text-lg'
            )}
          >
              ...
              <div className="flex col-span-2 space-x-4 md:col-span-1">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  {farm?.pair?.type === PairType.SWAP && (
                    <div className="text-xs md:text-base text-secondary">SureHive Farm</div>
                  )}
                  {farm?.pair?.type === PairType.KASHI && (
                    <div className="text-xs md:text-base text-secondary">HoneyStream Farm</div>
                  )}
                </div>
              </div>
