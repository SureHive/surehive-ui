...
export default function CurrencyInputPanel({
  ...
  return (
    <div id={id} className={classNames(hideInput ? 'p-4' : 'p-5', 'rounded bg-gray-100')}>
      <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
        ...
        {!hideInput && (
          <div
            className={classNames(
              'flex items-center w-full space-x-3 rounded bg-gray-200 focus:bg-dark-700 p-3 sm:w-3/5'
