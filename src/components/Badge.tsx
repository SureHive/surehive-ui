...
export const COLOR = {
  ...
  gradient:
    'bg-gradient-to-r from-blue to-light-blue opacity-80 hover:opacity-100 bg-light-blue bg-opacity-20 outline-pink rounded text-base text-dark-700 px-2 py-1',
}
