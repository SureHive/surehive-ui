...
const FILLED = {
  ...
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-gray-200 bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
...
const OUTLINED = {
  ...
  gradient:
    'border border-transparent border-gradient-r-blue-yellow-gray-200 opacity-80 hover:opacity-100 disabled:bg-opacity-20',
}
...
export const FilledButton = styled.button.attrs(({ className, ...rest }) => ({
  ...
  background-image: linear-gradient(238deg, #004bff 0%, #3772ff 42%, #0004f7 100%);
  border-radius: ${({ borderRadius = '28px' }) => borderRadius};
  width: ${({ width }) => width};
