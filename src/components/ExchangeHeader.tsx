...
const ExchangeHeader: FC<ExchangeHeaderProps> = ({ input, output, allowedSlippage }) => {
  ...
  return (
    <div className="flex justify-between mb-4 space-x-3 items-center">
      <div className="grid grid-cols-3 rounded p-3px bg-gray-100 h-[46px]">
        <NavLink
      ...
      <div className="flex items-center">
        <div className="grid grid-flow-col gap-1">
          {isLimitOrder && (
            <div className="items-center h-full w-full cursor-pointer hover:bg-gray-100 rounded px-3 py-1.5">
              <MyOrders />
            </div>
          )}
          {chainId === ChainId.MAINNET && (
            <div className=" text-green text-opacity-80 hover:text-opacity-100 hidden md:flex space-x-3 items-center hover:bg-gray-100 rounded h-full w-full px-3 cursor-pointer">
          ...
          <div className="relative w-full h-full rounded hover:bg-gray-100 flex items-center">
