  ...
  return (
    <Menu as="div" className="relative inline-block text-right">
      {({ open }) => (
        <>
          <div>
            <Menu.Button className="inline-flex justify-center w-full px-4 py-2 text-sm font-bold bg-transparent  focus:outline-none">
              <Image src={LANGUAGES[locale].flag} alt={LANGUAGES[locale].language} width={20} height={20} />
              <ChevronDownIcon className="w-5 h-5 ml-2 -mr-1 text-primary dark:text-white" aria-hidden="true" />
            </Menu.Button>
          </div>
