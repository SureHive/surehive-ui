...
export function BorrowCardHeader({ children }: any) {
  return <CardHeader className="border-b-8 bg-gray-yellow border-pink">{children}</CardHeader>
}

export function LendCardHeader({ children }: any) {
  return <CardHeader className="border-b-8 bg-gray-pink border-blue">{children}</CardHeader>
}
