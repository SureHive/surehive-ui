...
//   const { provider, account, chainId } = useWalletManager()
...
//     if (mode && state.selectedLPToken && account && provider) {
...
//     }
//   }, [mode, state, account, provider, amount, migrate, migrateWithPermit, chainId, addTransaction])
//
//   return {
//     ...state,
//     amount,
