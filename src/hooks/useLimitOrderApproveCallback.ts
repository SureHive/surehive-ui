...
//     //     {
//     //       warning: 'Give FULL access to funds in (and approved to) SureVault?',
//     //       user: account,
//     //       masterContract,
//     //       approved: true,
...
//     //   }
//     // }
//   }, [approvalState, account, provider, chainId, bentoBoxContract, masterContract])
//
...
//       summary.push(`Approve Limit Order and Deposit ${token.symbol} into SureVault`)
//       const {
//         signature: { v, r, s },
//       } = limitOrderPermit
//
...
//
//     if (!fromBentoBalance) {
//       summary.push(`Deposit ${token.symbol} into SureVault`)
//       if (token.isNative) {
//         batch.push(
