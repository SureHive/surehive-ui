...
import { DAI, SURE, USDC } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [SURE[1].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [4]: {
    ...
    [SURE[4].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [3]: {
    [SURE[3].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  ...
  [5]: {
    [SURE[5].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [42]: {
    [SURE[42].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
}
