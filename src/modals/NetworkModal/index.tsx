  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={672}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-pink">SURE</span>
        ...
        {[
          ...
          if (chainId === key) {
            return (
              <button key={i} className="w-full col-span-1 p-px rounded bg-gradient-to-r from-blue to-pink">
                <div className="flex items-center w-full h-full p-3 space-x-3 rounded bg-gray-300">
                  <Image
          ...
          return (
            <button
              ...
              className="flex items-center w-full col-span-1 p-3 space-x-3 rounded cursor-pointer bg-gray-100 hover:bg-dark-700"
            >
