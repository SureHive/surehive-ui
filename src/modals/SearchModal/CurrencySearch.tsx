      ...
      {!currencyList && (
        <div className="mt-3 mb-8">
          <input
            ...
            className="w-full bg-transparent border border-dark-700 focus:border-transparent focus:border-gradient-r-blue-yellow-gray-200 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5"
          />
        </div>
      )}
      {showCommonBases && (
