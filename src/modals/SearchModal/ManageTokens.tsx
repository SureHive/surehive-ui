    ...
    <div className="relative flex-1 w-full h-full mt-4 space-y-4 overflow-y-hidden">
      <div className="space-y-3">
        <input
          ...
          type="text"
          placeholder={'0x0000'}
          className="w-full bg-gray-200 border border-dark-800 focus:border-transparent focus:border-gradient-r-blue-yellow-gray-200 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5 appearance-none"
          value={searchQuery}
          autoComplete="off"
