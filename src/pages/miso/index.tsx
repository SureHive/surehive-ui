          ...
          <div className="flex flex-col w-full max-w-6xl items-center mx-8">
            ...
            <div className="gap-4 grid grid-cols-12 min-h-1/2 mb-6">
              ...
              <MisoArticles 
                ...
                content={`The auction receives $SURE as its payment token currency. Go to auction page, 
              ...
              <MisoArticles 
                ...
                content={`MISO is a suite of open-source smart contracts created to ease the process of launching 
                          a new project on the SureHive exchange. MISO aims to drive new capital and trade to the exchange 
                          by increasing the attractiveness of SureHive as a place for token creators and communities to launch 
                          new project tokens.`}
              />
            </div>
