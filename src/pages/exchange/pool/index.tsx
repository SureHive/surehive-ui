...
export default function Pool() {
  ...
  return (
    <>
      <Head>
        <title>Pool | SureHive</title>
        <meta
          key="description"
          name="description"
          content="SureHive liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
