  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-center text-low-emphesis">
        {i18n._(
          t`Your ${exchange} ${state.selectedLPToken.tokenA.symbol}/${state.selectedLPToken.tokenB.symbol} liquidity will become SureHive ${state.selectedLPToken.tokenA.symbol}/${state.selectedLPToken.tokenB.symbol} liquidity.`
        )}
      </div>
    </div>
  )
...
export default function Migrate() {
  ...
  return (
    <>
      <Head>
        <title>Migrate | SureHive</title>
        <meta key="description" name="description" content="Migrate your liquidity to SureHive." />
      </Head>
