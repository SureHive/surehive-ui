...
export default function Farm(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Farm | SureHive</title>
        <meta key="description" name="description" content="Farm SURE" />
      </Head>
      <Container maxWidth="full" className="grid h-full grid-cols-4 mx-auto gap-9">
        ...
        <div className={classNames('space-y-6 col-span-4 lg:col-span-3')}>
          <Search
            ...
            inputProps={{
              className:
                'relative w-full bg-transparent border border-transparent focus:border-gradient-r-blue-yellow-gray-200 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5',
            }}
          />
