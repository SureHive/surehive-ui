...
const tools = [
  {
    id: 1,
    name: 'MEOWSHI',
    description: 'Redonominate nSURE into MEOWSHI',
    href: '/tools/meowshi',
  },
  // {
  //   id: 2,
...
export default function Tools() {
  return (
    <>
      <Head>
        <title>Tools | SureHive</title>
        <meta key="description" name="description" content="SureHive tools..." />
      </Head>
      <div className="w-screen max-w-xl space-y-4">
        ...
        <ul className="space-y-4 divide-y-0">
          {tools.map((tool) => (
            <li key={tool.id} className="relative w-full p-4 rounded bg-gray-200 hover:bg-gray-100">
