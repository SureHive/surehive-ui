...
export default function Vesting() {
  ...
  return (
    <>
      <Head>
        <title>Vesting | SureHive</title>
        <meta key="description" name="description" content="SureHive vesting..." />
      </Head>
      <div className="w-full max-w-[900px] m-auto">
        <div className="flex px-0 sm:px-4 md:flex-row md:space-x-10 lg:space-x-20 md:px-10">
          ...
          <div className="flex flex-col gap-3 max-w-[400px]">
            <div className="relative w-full overflow-hidden rounded bg-gray-200">
              <div className="flex flex-col gap-3 p-4">
                <div className="flex flex-row justify-between">
                  <div className="font-bold text-dark-700">{i18n._(t`Your Claimable SURE this Week`)}</div>
                  <QuestionHelper text="Your Vested SURE will be released each week for the next 6 months. The amount released each week is determined by your historical farming rewards. You do not need to harvest each week as unclaimed amounts from each week will continue to accrue onto the next." />
                </div>
                ...
                <div className="flex flex-col items-baseline">
                  ...
                  {account ? (
                    <div className="text-sm text-secondary">
                      {totalLocked ? (
                        i18n._(t`Historical Total Locked: ${formatNumber(totalLocked)} SURE`)
                      ) : (
                ...
                >
                  {pendingTreasurySignature ? (
                    ...
                    <> {claimConfirmed ? i18n._(t`Claimed`) : i18n._(t`Claim SURE`)}</>
                  )}
            ...
            <div className="relative w-full overflow-hidden rounded bg-gray-200">
              <div className="flex flex-col gap-3 p-4">
                <div className="font-bold text-dark-700">{i18n._(t`Things you can do with your SURE`)}</div>
                <div className="p-4 rounded bg-gray-100">
                  <Link href="/stake">
                    <a className="flex items-center justify-between gap-3">
                      <div className="flex flex-col gap-1">
                        <div className="font-bold text-dark-700">{i18n._(t`Stake SURE for nSURE`)}</div>
                        <div className="text-sm text-secondary">
                          {t`Gain governance rights with nSURE and earn 5% APR (0.05% of
                  ...
                  <Link href={`/saave`}>
                    <a className="flex items-center justify-between gap-3">
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="text-sm text-secondary">
                          {t`Stake into nSURE add collateral as a nSURE on Aave all in
                                                            one click`}
                        </div>
                      </div>
                      <div className="min-w-[32px]">
                ...
                <div className="p-4 rounded bg-gray-100">
                  <div className="flex flex-col gap-1">
                    <div className="font-bold text-dark-700">{i18n._(t`Deposit SURE into SureVault`)}</div>
                    <div className="text-sm text-secondary">
