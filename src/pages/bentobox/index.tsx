...
export default function BenotBox() {
  ...
  return (
    <>
      <Head>
        <title>SureVault | SureHive</title>
        <meta
          key="description"
          name="description"
          content="SureVault is a token vault that generates yield for liquidity providers. SureVault creates a source of liquidity that any user can access with minimal approvals, minimal gas usage, and maximal capital efficiency."
        />
      </Head>
