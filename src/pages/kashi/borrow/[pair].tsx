...
function Pair() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow ${pair?.asset?.symbol}-${pair?.collateral?.symbol}`)} | SureHive</title>
        <meta
          key="description"
          name="description"
          content={`Borrow ${pair?.asset?.symbol} against ${pair?.collateral?.symbol} collateral on HoneyStream by SureHive`}
        />
      </Head>
      <Card
          ...
          <div className="flex-col space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <div className="text-lg text-high-emphesis">
                ...
                <QuestionHelper
                  text={i18n._(
                    t`SureVault strategies can create yield for your collateral tokens. This token does not yet have a strategy in the SureVault.`
                  )}
                />
              </div>
            </div>
