...
export default function Pair() {
  ...
  return (
    <>
      <Head>
        <title>Lend {pair.asset.tokenInfo.symbol} | SureHive</title>
          ...
          <div className="flex-col space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <div className="text-lg text-high-emphesis">
                ...
                <QuestionHelper
                  text={i18n._(
                    t`SureVault strategies can create yield for your liquidity while it is not lent out. This token does not yet have a strategy in the SureVault.`
                  )}
                />
              </div>
            </div>
