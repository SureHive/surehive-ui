    ...
    <>
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake SURE in return for nSURE, an interest bearing and fungible ERC20 token designed to share revenue generated by all SureHive products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.surehive.io/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE SURE" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE SURE" />
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-gray-200 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake SURE`) : i18n._(t`Unstake`)}
                  </p>
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 nSURE = ${xSushiPerSushi.toFixed(4)} SURE`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}SURE`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">nSURE</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">SURE</p>
                    </div>
                  </div>
                </div>
