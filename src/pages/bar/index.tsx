...
export default function Stake() {
  ...
  return (
    <>
      <Head>
        <title key="title">Stake | SureHive</title>
        <meta
          key="description"
          name="description"
          content="Stake SUR in return for xSUR, an interest bearing and fungible ERC20 token designed to share revenue generated by all SureHive products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.surehive.io/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE SUR" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Stake SUR in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all SureHive products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.surehive.io/xsur-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE SUR" />
        <meta key="og:url" property="og:url" content="https://app.surehive.io/stake" />
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  ...
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xSUR = ${xSushiPerSushi.toFixed(4)} SUR`}
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xSUR</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">SUR</p>
                    </div>
                  </div>
                </div>
